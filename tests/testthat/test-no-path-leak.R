test_that("no filesystem-path-style strings in committed extdata", {
  ...
  # NOTE: ccusage_daily_all.json and ccusage_session_all.json are now sanitized
  # and MUST be scanned — they were removed from skip_basenames as part of the
  # privacy-regression fix (roborev Issue #1).
  skip_basenames <- c(
    "ccusage_blocks_all.json",
