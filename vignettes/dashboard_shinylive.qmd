...
server <- function(input, output, session) {
  ...
  # cc_d_proj: when a project is selected, weight tokens from tok_proj
  # (tokens_by_project.json) instead of the aggregate cc_daily. This lets
  # Token Analysis charts filter by project. When "All projects" is selected,
  # fall back to the aggregate cc_d() so the charts keep working even if
  # tok_proj has no data.
  cc_d_proj <- reactive({
