...
ui <- page_navbar(
  ...
  header = tagList(
    tags$style(HTML("
      ...
      /* Fullscreen card: in-place, not cloned */
      .card.card-fullscreen {
        ...
        overflow: auto !important; border-radius: 0 !important;
        padding: 10px !important; margin: 0 !important;
      }
      .card.card-fullscreen .js-plotly-plot {
        width: calc(100vw - 40px) !important; height: calc(100vh - 100px) !important;
      }
      .card.card-fullscreen .dataTables_wrapper { font-size: 15px; overflow: auto; }
    ...
    tags$script(HTML("
      ...
      function enterFullscreen(card) {
        ...
        // Resize plotly to fill viewport
